...
int main(/*int argc, char *argv[]*/) {
    std::vector<HAND> hands{
        ...
        std::vector<Card>{Card{0, 3}, Card{1, 3}, Card{2, 3}, Card{3, 3}, Card{3, 13}},
        std::vector<Card>{Card{0, 9}, Card{1, 9}, Card{2, 9}, Card{3, 2}, Card{3, 2}},
        ...
        std::vector<Card>{Card{0, 7}, Card{1, 7}, Card{2, 7}, Card{3, 3}, Card{3, 13}},
